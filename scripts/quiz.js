...
function displayQuestions() {
  ...
  questionSection.innerHTML += `<p>${
    level[currentLevel].exercise[`question${currentQuestionIndex}`]
  }</p>`;
}
...
function next() {
  if (currentNoteIndex <= 3) {
    ...
    document.getElementById(`stageSelector-${currentLevel}`).disabled = false;
  } else {
